...
<html>
    ...
    <body>
        <%
            ...
            total = products.countProductByCategory(categoryID);
            if (total <= 8) {
                firstResult = 0;
                maxResult = total;
            } else {
            ...
            ArrayList<Product> listProduct = products.getListProductByPages(categoryID, firstResult, maxResult);
            ...
            <div class="container">
                <div class="content">
                    <div class="content-top">
                        ...
                        <%                            // for (Product p : products.getListProductByCategory(categoryID)) {
                            ...
                            <div class="col-md">
                                ...
                                <div class="top-content">
                                    ...
                                    <div class="white">
                                        ...
                                        <p class="dollar"><span><%=p.getProductPrice()%></span><span class="in-dollar">đ</span></p>
